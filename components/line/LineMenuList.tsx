...
const MenuRow: React.FC<MenuRowProps> = ({ menu, selectedMenuId, onSelectMenu, onDeleteSubMenu }) => (
  <div 
  ...
  >
    <div className="flex items-center gap-3">
      ...
      <div className="w-12 h-8 bg-gray-200 rounded flex-shrink-0 overflow-hidden border border-gray-100 relative">
          {menu.imageData ? (
            <img src={menu.imageData} alt="" className="w-full h-full object-cover" />
          ) : (
...
export const LineMenuList: React.FC<LineMenuListProps> = ({ 
  menus, 
  selectedMenuId, 
  onSelectMenu, 
  onAddSubMenu, 
